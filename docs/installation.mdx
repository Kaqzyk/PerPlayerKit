...
<Steps>
  <Step title="Download the Plugin">
    Grab the latest `PerPlayerKit-x.x.x.jar` from [Modrinth](https://modrinth.com/plugin/perplayerkit), [SpigotMC](https://www.spigotmc.org/resources/perplayerkit.121437/), or the [GitHub releases page](https://github.com/rossnoah/PerPlayerKit/releases). Always use the most recent stable release to get the latest bug fixes and features.
  </Step>
